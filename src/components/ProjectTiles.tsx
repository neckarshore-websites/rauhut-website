  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5">
      ...
      <a
        ...
        className="group flex h-full flex-col justify-between gap-6 overflow-hidden rounded-2xl bg-gradient-to-br from-[#0A2540] to-[#0F172A] p-6 text-[#F1F5F9] no-underline transition-[filter] duration-150 hover:brightness-110 hover:no-underline"
      >
        <div>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="group flex h-full flex-col justify-between gap-6 overflow-hidden rounded-2xl bg-gradient-to-br from-[#2E1065] to-[#1E0D47] p-6 text-[#F5F3FF] no-underline transition-[filter] duration-150 hover:brightness-110 hover:no-underline"
      >
        <div>
